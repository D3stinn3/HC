...
def signup(request, payload: SignupSchema):
    ...
    return {"success": True, "message": "User registered successfully.", "data": {"email": user.email}}
...
def user_login(request, payload: LoginSchema):
    ...
    if user is not None and not user.is_staff:
        return {"success": True, "message": "User login successful.", "data": {"email": user.email, "user_id": user.pk, "username": user.username}}
...
def admin_login(request, payload: LoginSchema):
    ...
    if user is not None and user.is_staff:
        return {"success": True, "message": "Admin login successful.", "data": {"email": user.email, "user_id": user.pk, "username": user.username}}
...
def user_logout(request):
    ...
    return {"success": False, "message": "User is not authenticated.", "data": {"email": user_.email, "username": user_.username}}
